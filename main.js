...
function addModel2() {
    //Load our model
    loader.load('ConnectionHead.glb', (gltf) => {
        const model = gltf.scene;
        model.position.set(0.13, -0.01, -0.2);
        model.rotation.y = -Math.PI /2;
        model.scale.set(1.5, 1.5, 1.5);
        model.traverse((child) => {
            if (child.isMesh) {
                child.userData.link = 'connection.html';
            }
        });
...
function addModel3() {
    //Load our model
    loader.load('ConnectionPart.glb', (gltf) => {
        const model = gltf.scene;
        model.position.set(0.05, -0.01, -0.2);
        model.scale.set(1.5, 1.5, 1.5);
...
function addModel4() {
    ...
    loader.load('ConnectionPart.glb', (gltf) => {
        const model = gltf.scene;
        model.position.set(0.005, -0.01, -0.2);
        model.scale.set(1.5, 1.5, 1.5);
...
function addModel5() {
    ...
    loader.load('HipJoint.glb', (gltf) => {
        ...
        model.traverse((child) => {
            if (child.isMesh) {
                child.userData.link = 'HipJoint.html';
            }
        });
